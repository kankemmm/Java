...
public class Winbonus {
	...
	public static void main(String[] args) {
		...
		if(guess == lottery) System.out.println("you win $10,000");
				...
				|| guessDigit3 == lotteryDigit3 && guessDigit1 == lotteryDigit2 && guessDigit2 == lotteryDigit2)
		{
			System.out.println("Mach all digits£º you win $3,000");
		}
